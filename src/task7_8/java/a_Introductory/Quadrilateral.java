...
public class Quadrilateral {
	...
	public Boolean isRectangle() {
		...
		boolean sameLengths = l1.isSameLengthAs(l3) && l2.isSameLengthAs(l4);
		boolean isAllOrthogonal = (v1.isOrthogonalTo(v2) &&
				v2.isOrthogonalTo(v3) &&
				v3.isOrthogonalTo(v4) &&
				v4.isOrthogonalTo(v1));
		boolean areParallel = v1.crossProduct(v3) == 0 && v2.crossProduct(v4) == 0;
		return sameLengths && isAllOrthogonal && areParallel ;
	}
	
	public Boolean isSquare() {
		return (l1.isSameLengthAs(l2) && l2.isSameLengthAs(l3) && l3.isSameLengthAs(l4));
	}
